...
struct PageIndicator: View {
    ...
    init(numPages: Int, currentPage: Binding<Int>, selectedColor: Color, unSelectedColor: Color, spacing: CGFloat) {
...
//        DotIndicator(pageIndex: 0, slectedPage: .constant(0), selectedColor: .red)
...
struct PageIndicator_Previews: PreviewProvider {
    static var previews: some View {
        PageIndicator(numPages: 5, currentPage: .constant(2), selectedColor: .red, unSelectedColor: .green, spacing: 10)
